...
//   Dégradé Doux et Élégant :

// #FFDEE9 (rose pâle)
// #B5FFFC (bleu clair)
// #C3E0E5 (bleu gris)
// Dégradé Chaleureux et Accueillant :

// #FF9A8B (corail)
// #FF6A88 (rose vif)
// #FF99AC (rose saumon)
// Dégradé Naturel et Apaisant :
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-gradient-to-br from-blue-200 via-blue-800 to-blue-400">
      ...
      <div className="absolute left-1/2 bottom-16 sm:bottom-10 transform -translate-x-1/2">
        <div className="w-0 h-0 border-l-[30px] sm:border-l-[60px] border-r-[30px] sm:border-r-[60px] border-b-[50px] sm:border-b-[100px] border-transparent border-b-blue-400 relative animate-pulse" />
        <div className="w-0 h-0 border-l-[40px] sm:border-l-[75px] border-r-[40px] sm:border-r-[75px] border-b-[60px] sm:border-b-[120px] border-transparent border-b-blue-500 relative -mt-10 sm:-mt-20 animate-pulse" />
        <div className="w-0 h-0 border-l-[50px] sm:border-l-[90px] border-r-[50px] sm:border-r-[90px] border-b-[70px] sm:border-b-[140px] border-transparent border-b-blue-600 relative -mt-14 sm:-mt-28 animate-pulse" />
      ...
      {/* Message responsive */}
      <div
        className={`absolute top-1/2 sm:top-1/3 w-full left-1/2 transform flex flex-col gap-2 -translate-x-1/2 -translate-y-1/2 text-center transition-all duration-1000 px-4 ${
      ...
      >
        ...
        <p
          className=" text-xl text-white mt-[-14px] animate-pulse shadow-text-sm"
        >
          Délanno KOTCHO
        </p>
      </div>
